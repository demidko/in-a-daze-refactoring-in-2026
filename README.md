...
* Порог входа в pet-проекты упал до нуля
    ...
    * ...даже если ты боялся конструкций вида `++*(&**ptr)`
* Когда ты разрабатываешь что-то с llm, то автоматически, одновременно учишься
* Необходимые в процессе знания таким образом напрямую попадают в кеш твоей памяти
* Llm становятся легальным бустом твоего мозга, как плагин-расширение
